...
<div className="container row">
  <div className="col-md-3 ">  
   ...
   <img 
     ...
     alt="profile-pic justify-content-center" />
     <h6 
     style={{color: "black", textAlign: "center"}}>TUNIK 
     </h6>
    </NavLink> 
  </div>
  ...
  <div className="col-md-3 ">  
    ...
    alt="profile-pic justify-content-center" />
    <h6 
    style={{color: "black", textAlign: "center"}}>SHIRT 
    </h6>
    </NavLink> 
  </div>
  ...
  <div className="col-md-3 ">   
    ...
    alt="profile-pic justify-content-center" />
    <h6 
    style={{color: "black", textAlign: "center"}}>OUTHER 
    </h6>
    </NavLink> 
  </div>
 ...
 <div className="col-md-3 ">   
  ...
  >
   ...
   alt="profile-pic justify-content-center" />
   <h6 
   style={{color: "black", textAlign: "center"}}>BUTTOMS 
   </h6>
  </NavLink> 
 </div>
</div>
